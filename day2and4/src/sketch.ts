...
export const sketch = (p: p5) => {
  ...
  p.draw = () => {
    ...
    const quarterCanvasWidth = Math.floor(PARAMS.width * 0.5),
      quarterCanvasHeight = Math.floor(PARAMS.height * 0.5);
    drawThingy(p, ramps[0], 27, quarterCanvasWidth, quarterCanvasHeight, 0, 0);
    drawThingy(p, ramps[1], 27, quarterCanvasWidth, quarterCanvasHeight, quarterCanvasWidth, 0);
    drawThingy(p, ramps[2], 27, quarterCanvasWidth, quarterCanvasHeight, 0, quarterCanvasHeight);
    drawThingy(p, ramps[3], 27, quarterCanvasWidth, quarterCanvasHeight, quarterCanvasWidth, quarterCanvasHeight);
